<template>
  <div class="d-flex flex-column">
    <div class="content border border-1 shadow-sm p-3 bg-body-tertiary rounded">
      <div class="text-center h1">title</div>
      <div>desc</div>
      <div>
        <MdEditor
          class="bg-body-tertiary border-0"
          v-model="text"
          ref="editor"
          :toolbars="[]"
          :footers="[]"
...
import { UToast, createObjectURL, usePage } from "undraw-ui";

onMounted(() => {
  editor.value?.togglePreviewOnly(true);
});
